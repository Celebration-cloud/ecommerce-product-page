...
function CartInfo({ detail, handleRemove }) {
  ...
  return (
    <>
      ...
      >
        <Typography sx={{ p: 2 }}>
          <span style={{ textAlign: "left", padding: "5px", fontSize: 20, fontWeight: "bolder" }}>Cart</span>
          <hr />
          ...
          {detail.length > 0 && (
            <>
              <hr />
              <button
                style={{bottom: "0", position: "sticky", width: "100%", border: "none", height: "50px", backgroundColor: "orangered" }}
              >
                Total: 
              </button>
            </>

...
function CartInfo({ detail, handleRemove, handleChecking, handleTick }) {
  const [cart, setCart] = React.useState(null);
  const [check, setCheck] = useState(detail.check);
  ...
  const handleCheck = (e) => {
    ...
    setCheck(prev => {return {...prev, [name]: type ? checked : value}})
    handleChecking(check);
    handleTick(detail.id)
  };

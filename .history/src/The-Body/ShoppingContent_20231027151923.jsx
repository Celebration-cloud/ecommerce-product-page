...
function ShoppingContent() {
  return (
    <div className="col">
      ...
      <p style={{textDecoration: "line-through", fontWeight: "lighter"}}>$250.00</p><br/>
      <div>
        <span><button>-</button><input style={{width: "50px", padding: "8px", border: "none"}}  defaultValue={0}/><button style={{backgroundColor: "transparent", color: "or"}}>+</button></span>
      </div>
